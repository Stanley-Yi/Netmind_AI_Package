...
class APIWrapTool:
    ...
    def run_api(self):
        ...
        This method wraps the function into two API endpoints: a GET endpoint at "/" that returns the function's documentation, and a POST endpoint at "/interface/" that runs the function with the provided input.
