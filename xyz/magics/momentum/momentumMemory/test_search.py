...
#     memory_instance.end_task(step_4P2P2)
...
#     memory_instance.end_task(step_5)
    ...
    memory_instance.search_memory('I ate a lot of high-calorie foods during the Chinese New Year and gained 10 pounds. I want to lose weight.', 'I hope to lose 10 pounds and stay in good shape')
